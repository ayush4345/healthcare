...
- **Book Appointments**: Patients can schedule and manage multiple appointments with doctors.
- **Admin Appointment Management**: Administrators can view, confirm, schedule, and cancel appointments.
...
- **Performance Monitoring**: Integrated with Sentry for performance tracking and error detection.
